    ...
    useEffect(() => {
        const fetchListDetails = async () => {
            try {
                setLoading(true);
                // Fetch list details
                const listResponse = await fetch(`${import.meta.env.VITE_API_URL}/lists/${id}/`, {
                    headers: {
                ...
                const itemsResponse = await fetch(`${import.meta.env.VITE_API_URL}/items/?list_id=${id}&archived=false`, {
                    headers: {
                        'Authorization': `Token ${auth.token}`,
